    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="">
                    <a href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3 me-1" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                        <i class="btn-inner">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" aria-describedby="email" placeholder="Permission Title">
                                    </div>
